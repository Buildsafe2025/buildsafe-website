      ...
      <div className="container h-full flex md:items-center relative">
        ...
        >
          <h1 className="heading-1">
            Expert In Construction Engineering Consultancy, Project Management
            and Reality Capture
          </h1>
          <p className="text-sm md:text-base">
            Delivering top-tier construction engineering consultancy, project
            management, and reality capture services across Nigeria, with a
          ...
          <Link href={"/services"}>
            <button className="bg-primary text-white rounded-xl flex items-center gap-2 py-1.5 px-2.5 text-xs md:text-sm custom-hover">
              ...
              <span className="flex justify-center align-middle align-items-center align-content-center rounded-full bg-white">
                <span className=" text-primary text-lg px-1">&rarr;</span>
              </span>
            </button>
          </Link>
        </div>
